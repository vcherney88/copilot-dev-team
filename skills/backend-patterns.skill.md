...
description: Reference code templates for backend implementation. Consult this skill when writing controllers, services, entities, repositories, DTOs, DI registration, or migrations.
---

# Backend Code Patterns

> These are reference templates extracted from the project. Follow this shape for consistency.
> Adapt to the stack defined in `architecture.instructions.md`.
...
## Entity (plain class, no data annotations)
